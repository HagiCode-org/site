...
- [Steam](https://store.steampowered.com/app/4625540/Hagicode/) для версии Steam с нативной для платформы дистрибуцией
...
- Проверки первого деплоя: убедитесь, что workflow публикует `esa.jsonc` и `dist/`, что целевой хостинг по-прежнему смотрит на `gh-pages`, и затем откройте `https://hagicode.com`
