...
```mermaid
flowchart LR
    S0[阶段 0<br/>新想法<br/>用户] --> S1[阶段 1<br/>优化中<br/>AI]
    S1 --> S2[阶段 2<br/>草稿<br/>手动]
    S2 --> S3[阶段 3<br/>生成中<br/>AI]
    S3 --> S4[阶段 4<br/>审查<br/>手动]
    S4 --> S5[阶段 5<br/>执行中<br/>AI]
    S5 --> S6[阶段 6<br/>执行完成<br/>用户]
    S6 --> S7[阶段 7<br/>归档中<br/>AI]
    S7 --> S8[阶段 8<br/>已归档]
```
