...
<div style="width: 100%; margin-bottom: 2.5rem;">
  <iframe
    src="https://player.bilibili.com/player.html?bvid=BV19967B6EHr&page=1&high_quality=1&danmaku=0&autoplay=0"
    style="width: 100% !important; height: 500px !important; border: none; display: block; min-height: 500px !important;"
    scrolling="no"
    border="0"
    frameborder="no"
    framespacing="0"
