    ...
    return {
      ...
      dlcItems: [
        ...
        },
        {
          ...
          price: 'View on Steam',
          description: 'You can buy this DLC on its own to expand the original proposal concurrency cap. We will usually highlight a bundled purchase option called Hagicode Plus so the overall purchase price stays lower. Please check our store page for the latest changes.',
          bullets: [
  ...
  return {
    ...
    dlcItems: [
      ...
      },
      {
        ...
        title: 'Hagicode: Turbo Engine DLC',
        price: '点击查看',
        description: '用户可以单独购买这个 DLC 来扩展原来的并发数。通常情况下，我们会重点突出一个名为 Hagicode Plus 的一并购买套餐，使总体购买价格更低，请注意查看我们的商店页面变化。',
        bullets: [
          '解锁文案切换支持',
          '最大提案并行数扩展到 32',
        ],
