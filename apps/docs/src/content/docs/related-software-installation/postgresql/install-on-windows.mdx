...
![打开安装界面](../../img/installation/install-postgres-windows/1.打开安装界面.png)
...
![设置安装的文件夹](../../img/installation/install-postgres-windows/2.设置安装的文件夹.png)
...
![设置安装的内容](../../img/installation/install-postgres-windows/3.设置安装的内容.png)
...
![设置数据库存放数据的文件夹](../../img/installation/install-postgres-windows/4.设置之后数据库存放数据的文件夹.png)
...
![设置数据库初始用户的密码](../../img/installation/install-postgres-windows/5.设置数据库初始用户的密码.png)
...
![设置数据库端口](../../img/installation/install-postgres-windows/6.设置数据库的端口.png)
...
![设置数据库字符集](../../img/installation/install-postgres-windows/7.设置数据库的字符集和文化.png)
...
![查看安装计划](../../img/installation/install-postgres-windows/8.查看安装的计划.png)
...
![准备开始安装](../../img/installation/install-postgres-windows/9.准备开始安装，点击下一步开始.png)
...
![安装进度](../../img/installation/install-postgres-windows/10.实时展示安装进度.png)
...
![安装完成](../../img/installation/install-postgres-windows/11.安装已完成.png)

取消勾选"Launch Stack Builder at exit?"（除非您需要额外的扩展），然后点击"完成"按钮退出安装向导。

## 下一步

PostgreSQL 安装完成后，[返回安装指南](/installation)继续配置。
