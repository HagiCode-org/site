...
Node.js 安装完成后，您可以继续以下步骤：

<CardGrid>

<LinkCard title="安装 OpenSpec" href="/related-software-installation/openspec/setup-openspec"
    description="安装 OpenSpec 规范驱动开发工具，管理提案、规范和变更。"
/>

<LinkCard title="安装 Claude Code" href="/related-software-installation/claude-code/setup-claude-code-with-zai"
    description="安装 Claude Code AI 辅助开发工具，体验智能编程助手。"
/>

<LinkCard title="返回安装指南" href="/installation"
    description="返回主安装指南，继续配置其他依赖项。"
/>
