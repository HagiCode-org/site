...
<InstallButton variant="full" client:load />
...
![Desktop 安装程序](/img/install-desktop/hagicode-desktop-正在安装中.png)
...
![安装向导第一步](/img/install-desktop/向导第一步，点击开始安装.png)
...
![安装向导第二步](/img/install-desktop/向导第二步，自动下载最新版本安装.png)
...
![检查依赖项](/img/install-desktop/向导第三步，检查版本的依赖项.png)

#### 安装依赖项

如果检测到缺少依赖项，您将看到以下界面，可以一键安装所有缺失的组件。

![一键安装依赖项](/img/install-desktop/向导第三步，检查完成之后可以一键安装依赖项.png)
...
![安装 .NET 运行时](/img/install-desktop/向导第三步-正在安装dotnet-运行时的示例.png)

#### 完成依赖项安装

当所有依赖项安装完成后，您将看到成功提示。

![依赖项安装完成](/img/install-desktop/向导第三步，安装所有依赖项完成.png)
...
![启动 Hagicode Server](/img/install-desktop/向导第四步-正在启动-hagicode-server.png)
...
![服务启动完成](/img/install-desktop/向导第四步-server-启动之后可以点击-hagicode-开始使用.png)
...
![创建项目向导](/img/install-desktop/进入hagicode-之后可以通过内部向导开始创建项目.png)
...
![导入 Git 仓库](/img/install-desktop/通过输入一个文件夹-可以扫描这个文件夹地下所有的-git-仓库进行导入.png)
...
![版本管理](/img/install-desktop/可以在版本管理页面对不同的版本进行切换.png)
...
![启动服务](/img/install-desktop/在首页可以通过启动服务来启动hagicode-server.png)
