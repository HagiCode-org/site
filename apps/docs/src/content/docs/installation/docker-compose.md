...
Docker Compose Builder 现在作为独立工具提供，地址：[https://builder.hagicode.com/](https://builder.hagicode.com/)。它提供相同的功能，并定期更新和改进用户体验。
:::

:::tip[使用配置生成器]
**推荐使用 [Docker Compose Builder (独立站点)](https://builder.hagicode.com/)**！
