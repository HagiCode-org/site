...
import { getDesktopVersionData, type DesktopVersionData } from '@shared/version-manager';
import { detectOS, getAssetTypeLabel, groupAssetsByPlatform } from '@shared/desktop-utils';
import type { DesktopVersion, AssetType } from '@shared/types/desktop';
